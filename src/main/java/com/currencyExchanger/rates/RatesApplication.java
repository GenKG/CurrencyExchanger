...
import com.currencyExchanger.rates.Service.RestTemplateService;
...
public class RatesApplication {
	...
	public static void main(String[] args) throws JsonProcessingException {
		...
		RestTemplateService service = context.getBean(RestTemplateService.class);
		service.getDataForURL();
	}
